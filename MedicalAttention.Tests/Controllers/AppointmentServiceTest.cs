...
namespace MedicalAttention.Tests.Controllers
{
    ...
    public class AppointmentServiceTest
    {
        ...
        public void CreateValidAppointment()
        {
            ...
            var service = new AppointmentService(mockRepository.Object, mockPatientService.Object, mockDoctorService.Object);
            service.CreateAppointment(new Appointment() { Id = 3, Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day + 1, 10, 20, 0), Doctor = new Doctor() { Id = 1 }, Patient = new Patient() { Id = 1 } });
        }
        ...
        public void UpdateValidAppointment()
        {
            ...
            var service = new AppointmentService(mockRepository.Object, mockPatientService.Object, mockDoctorService.Object);
            service.UpdateAppointment(3, new Appointment() { Id = 3, Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day + 1, 10, 20, 0), Doctor = new Doctor() { Id = 1 }, Patient = new Patient() { Id = 1 } });
        }
